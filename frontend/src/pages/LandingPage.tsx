        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-5 sm:px-10 md:px-14 pt-20 pb-20">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <button
              ...
              className="w-full sm:w-auto px-7 py-3.5 bg-white/[0.06] hover:bg-white/[0.12] border border-white/15 hover:border-white/25 text-white font-semibold rounded-xl hover:scale-[1.02] active:scale-95 transition-all backdrop-blur-sm cursor-pointer"
            >
              Join a room
            </button>
          </div>
